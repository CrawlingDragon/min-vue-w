...
function createComponent(vnode, parent) {
    const component = Object.assign(Object.assign({ vnode: vnode, next: null }, vnode), { type: vnode.type, update: null, setupState: {}, props: {}, slot: {}, emit: () => { }, isMounted: false, subTree: {}, // 用于标记组件的 虚拟dom树
...
export { createApp, createRenderer, createTextVnode, getCurrentInstance, h, inject, nextTick, provide, ref, renderSlots, shallowReadonly };
